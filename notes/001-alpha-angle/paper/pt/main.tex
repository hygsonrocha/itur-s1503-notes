...
\begin{document}
	...
	% ============================================================
	\chapter*{Escopo e reprodutibilidade}
	\addcontentsline{toc}{chapter}{Escopo e reprodutibilidade}
	...
	A ideia é manter esta nota \emph{sem} colagem de código-fonte (para evitar divergências e problemas de compilação \LaTeX);
	o código em \texttt{.py} é a ``fonte de verdade'' e o notebook apenas mostra exemplos.
	...
	% ============================================================
	\chapter*{Definição de \texorpdfstring{$\alpha$}{alpha} e notação}
	\addcontentsline{toc}{chapter}{Definição de alpha e notação}
	...
	com base na interseção da reta ES\(\rightarrow\)NGSO com o plano equatorial \(XY\) (Capítulo \ref{chap:sinal}).
	...
	% ============================================================
	\chapter*{Arco GSO visível a partir da ES}
	\addcontentsline{toc}{chapter}{Arco GSO visível a partir da ES}
	...
	\]
	A desigualdade define um intervalo simétrico em torno de \(\lambda_E\):
	\[
	|\lambda-\lambda_E|\;\le\;\theta_{\max},
	\qquad
	\theta_{\max}=\arccos\!\left(\frac{\Rearth}{\Rgeo\cos\varphi_E}\right),
	\]
	desde que \(\cos\varphi_E>\Rearth/\Rgeo\).
	
	\paragraph{Caso sem arco visível.}
	Se \(\cos\varphi_E\le \Rearth/\Rgeo\), não existe \(\lambda\) satisfazendo a condição de visibilidade.
	Nesse caso, adota-se a convenção operacional:
	\[
	|\alpha|=\pi.
	\]
	...
	% ============================================================
	\chapter*{Minimização de \texorpdfstring{$\alpha(\lambda)$}{alpha(lambda)} como maximização}
	\addcontentsline{toc}{chapter}{Minimizacao de alpha(lambda) como maximizacao}
	...
	% ============================================================
	\chapter*{Critério de sinal de \texorpdfstring{$\alpha$}{alpha}}
	\addcontentsline{toc}{chapter}{Criterio de sinal de alpha}
	\label{chap:sinal}
	...
	% ============================================================
	\chapter*{Como usar o código}
	\addcontentsline{toc}{chapter}{Como usar o codigo}
	
	\paragraph{Arquivos.}
	No repositório, mantenha:
	\begin{itemize}\tightlist
		\item \texttt{src/alpha\_angle.py} como “fonte de verdade” do algoritmo;
		\item \texttt{notebooks/alpha\_angle\_demo.ipynb} como demonstração/validação.
	\end{itemize}
